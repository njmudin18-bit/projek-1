...
<body>
                              ...
                              <table id="order-table" class="table table-striped table-bordered nowrap" width="100%"
                                ...
                                <thead>
                                  <tr class="">
                                    ...
                                    <th class="text-center bg-primary">Qty PO</th>
                                    <th class="text-center bg-primary">Stock</th>
                                    <th class="text-center bg-primary">WIP</th>
                                    <th class="text-center bg-primary">Qty Pengiriman</th>
                                    <th class="text-center bg-primary">Sisa Qty Pengiriman</th>
                                    <th class="text-center bg-primary">Status PO</th>
  ...
  $(document).ready(function() {
    ...
    table = $('#order-table').DataTable({
      ...
      'serverMethod': 'POST',
      'ajax': {
        url: "<?php echo base_url(); ?>sales_order/sales_order_by_po",
        type: 'POST',
        "data": function(data) {
      ...
      'aoColumns': [{
        ...
        {
          "Qty Pengiriman": "Qty Pengiriman",
          "sClass": "text-right"
        },
        {
          "Sisa Qty Pengiriman": "Sisa Qty Pengiriman",
          "sClass": "text-right"
        },
        {
          "Status": "Status",
