...
<script type="text/javascript" src="<?php echo base_url(); ?>files/bower_components/moment/js/moment.min.js"></script>
<!-- <script type="text/javascript" src="<?php //echo base_url(); 
                                          ?>files/bower_components/fullcalendar/js/fullcalendar.min.js"></script> -->
<!-- <script type="text/javascript" src="<?php //echo base_url(); 
                                          ?>files/assets/pages/full-calender/calendar.js"></script> -->

<script type="text/javascript" src="<?php echo base_url(); ?>files/assets/js/calendar_v1.js"></script>
...
<script type="text/javascript" src="<?php echo base_url(); ?>files/assets/js/script_custom.js"></script>>