          ...
          <form id="more_ng_form">
            <div id="contentku">
              ...
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Qty.</label>
                <div class="col-sm-10">
                  <input type="number" class="form-control" name="qty_view" id="qty_view" max="4" maxlength="4" autocomplete="off" placeholder="masukan hanya nomor" onkeypress="if(this.value.length==4) return false;">
                  <span class="help-block"></span>
                </div>
              </div>
              <div class="form-group row">
