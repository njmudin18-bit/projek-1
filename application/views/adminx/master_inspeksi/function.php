...
<body>
        ...
        <div class="modal-body">
          <form id="RegisterValidation">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" id="standard" name="standard" class="form-control" required="required">
                <span class="help-block"></span>
              </div>
            </div>
            <div class="form-group row">
              <label class="col-sm-2 col-form-label">Toleransi</label>
              <div class="col-sm-10">
                <input type="text" id="toleransi" name="toleransi" class="form-control" required="required">
                <span class="help-block"></span>
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" id="tools" name="tools" class="form-control" required="required">
                <span class="help-block"></span>
              </div>
            </div>
            <div class="form-group row">
  ...
  <script>
    ...
    function edit(id) {
      ...
      $.ajax({
        url: "<?php echo base_url() ?>master_inspection/function_inspection_edit/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
          if (data.status == 'forbidden') {
            ...
            $('[name="toleransi"]').val(data.toleransi);
    ...
    function openModalDelete(id) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $.ajax({
            url: '<?php echo base_url(); ?>master_inspection/function_inspection_deleted/' + id,
            type: 'DELETE',
            error: function() {
    ...
    function save() {
      ...
      if (save_method == 'add') {
        url = "<?php echo base_url(); ?>master_inspection/function_inspection_add";
      } else {
        url = "<?php echo base_url(); ?>master_inspection/function_inspection_update";
      }
    ...
    $(document).ready(function() {
      ...
      table = $('#order-table').DataTable({
        ...
        "ajax": {
          "url": "<?php echo base_url(); ?>master_inspection/function_inspection_list",
          "type": "POST",
        },
