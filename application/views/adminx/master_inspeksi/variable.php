...
<body>
  ...
  <script>
    ...
    function edit(id) {
      ...
      $.ajax({
        url: "<?php echo base_url() ?>master_inspection/variable_inspection_edit/" + id,
        type: "GET",
        dataType: "JSON",
    ...
    function openModalDelete(id) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $.ajax({
            url: '<?php echo base_url(); ?>master_inspection/variable_inspection_deleted/' + id,
            type: 'DELETE',
            error: function() {
    ...
    function save() {
      ...
      if (save_method == 'add') {
        url = "<?php echo base_url(); ?>master_inspection/variable_inspection_add";
      } else {
        url = "<?php echo base_url(); ?>master_inspection/variable_inspection_update";
      }
    ...
    $(document).ready(function() {
      ...
      table = $('#order-table').DataTable({
        ...
        "ajax": {
          "url": "<?php echo base_url(); ?>master_inspection/variable_inspection_list",
          "type": "POST",
        },
