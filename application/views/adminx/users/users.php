  ...
  <body>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>files/assets/js/sweetalert2.all.min.js"></script>
      ...
      function save()
      {
        ...
        data_save.push({ name: "department_name", value: dept_name });
        data_save.push({ name: "karyawan_name", value: pegawai_name });
	    ...
	    $(document).ready(function() {
	      ...
	      table = $('#order-table').DataTable({ 
            ...
            "aoColumns": [
              ...
              { "#": "#" , "sClass": "text-center" },
              { "DEPT": "DEPT" , "sClass": "text-left" },
              { "NIP": "NIP" , "sClass": "text-left" },
              { "Nama": "Nama" , "sClass": "text-left" },
              { "Email": "Email" , "sClass": "text-left" },
              { "Username": "Username" , "sClass": "text-left" },
              { "Level": "Level" , "sClass": "text-left" },
              { "Roles": "Roles" , "sClass": "text-left" },
              { "Aktivasi": "Aktivasi" , "sClass": "text-left" },
